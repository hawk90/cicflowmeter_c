...
#define LOG_TRACE_MSG(...) \
    logger(LOG_TRACE, __FILE__, __func__, __LINE__, ERROR_NONE, __VA_ARGS__)
#define LOG_DBG_MSG(...) \
    logger(LOG_DEBUG, __FILE__, __func__, __LINE__, ERROR_NONE, __VA_ARGS__)
#define LOG_INFO_MSG(...) \
    logger(LOG_INFO, __FILE__, __func__, __LINE__, ERROR_NONE, __VA_ARGS__)
#define LOG_NOTI_MSG(...) \
    logger(LOG_NOTICE, __FILE__, __func__, __LINE__, ERROR_NONE, __VA_ARGS__)
#define LOG_WARN_MSG(error_code, ...) \
    logger(LOG_WARNING, __FILE__, __func__, __LINE__, error_code, __VA_ARGS__)
#define LOG_ERR_MSG(error_code, ...) \
    logger(LOG_ERROR, __FILE__, __func__, __LINE__, error_code, __VA_ARGS__)
#define LOG_CRIT_MSG(error_code, ...) \
