...
#define FLOW_FILE_NONE_TS                                                  \
    (FLOW_FILE_NO_MAGIC_TS | FLOW_FILE_NO_STORE_TS | FLOW_FILE_NO_MD5_TS | \
     FLOW_FILE_NO_SHA1_TS | FLOW_FILE_NO_SHA256_TS | FLOW_FILE_NO_SIZE_TS)
#define FLOW_FILE_NONE_TC                                                  \
    (FLOW_FILE_NO_MAGIC_TC | FLOW_FILE_NO_STORE_TC | FLOW_FILE_NO_MD5_TC | \
     FLOW_FILE_NO_SHA1_TC | FLOW_FILE_NO_SHA256_TC | FLOW_FILE_NO_SIZE_TC)
...
#define FLOW_RESET_PE_DONE(f, dir)                         \
    (((dir)&STREAM_TOSERVER)                               \
         ? ((f)->flags &= ~FLOW_TS_PE_ALPROTO_DETECT_DONE) \
         : ((f)->flags &= ~FLOW_TC_PE_ALPROTO_DETECT_DONE))
