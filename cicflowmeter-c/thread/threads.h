...
#ifndef __CICFLOWMETER_THREAD_THREADS_H__
#define __CICFLOWMETER_THREAD_THREADS_H__
...
/* spinlocks */
    ...
    !defined(HAVE_PTHREAD_SPIN_UNLOCK)
...
#endif
#if (!defined SCCtrlMutex || !defined SCCtrlMutexAttr ||          \
     !defined SCCtrlMutexInit || !defined SCCtrlMutexLock ||      \
     !defined SCCtrlMutexTrylock || !defined SCCtrlMutexUnlock || \
     !defined SCCtrlMutexDestroy)
#error "SCCtrlMutex types and/or macro's not properly defined"
#endif

#if (!defined SCSpinlock || !defined SCSpinLock || !defined SCSpinTrylock || \
     !defined SCSpinUnlock || !defined SCSpinInit || !defined SCSpinDestroy)
#error "Spinlock types and/or macro's not properly defined"
     ...
     !defined SCRWLockTryRDLock || !defined SCRWLockUnlock ||                 \
     !defined SCRWLockDestroy)
...
#if (!defined SCCtrlCondT || !defined SCCtrlCondInit ||         \
     !defined SCCtrlCondSignal || !defined SCCtrlCondDestroy || \
     !defined SCCtrlCondTimedwait)
...
#define SCSetThreadName(n)                                            \
    ({                                                                \
        ...
        if ((ret = prctl(PR_SET_NAME, tname, 0, 0, 0)) < 0)           \
            SCLogDebug("Error setting thread name \"%s\": %s", tname, \
                       strerror(errno));                              \
        ret;                                                          \
    })
#else
